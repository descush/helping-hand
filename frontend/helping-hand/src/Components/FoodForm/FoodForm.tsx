...
export function FoodForm() {
    ...
    function handleServingTypeChange(food: FoodEntry, servingType: string) {
        ...
        switch (servingType) {
            case 'Palm':
                updatedFood.proteinAmount = servingSize[food.fdcId] || 0;
                updatedFood.proteinType = servingType;
                break;
            case 'Fist':
                updatedFood.veggiesAmount = servingSize[food.fdcId] || 0;
                updatedFood.veggiesType = servingType;
                break;
            case 'Thumb':
                updatedFood.fatsAmount = servingSize[food.fdcId] || 0;
                updatedFood.fatsType = servingType;
                break;
            case 'Cupped Handfuls':
                updatedFood.carbsAmount = servingSize[food.fdcId] || 0;
